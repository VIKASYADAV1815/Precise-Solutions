...
export default function CategoryGrid() {
  return (
    <section className="pt-6 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 h-auto md:h-[480px] lg:h-[560px]">
        {/* Large Left Item */}
        <motion.div 
          ...
          className="relative h-[400px] md:h-full rounded-[2rem] overflow-hidden group bg-slate-100"
        >
          <Image 
        ...
        {/* Right Stack */}
        <div className="grid grid-rows-2 gap-4 lg:gap-8 h-[480px] md:h-full">
          {/* Top Right Item */}
          <motion.div 
            ...
            className="relative h-full rounded-[2rem] overflow-hidden group bg-slate-100"
          >
            <Image 
